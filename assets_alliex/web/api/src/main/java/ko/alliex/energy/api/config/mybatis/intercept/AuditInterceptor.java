package ko.alliex.energy.api.config.mybatis.intercept;

import ko.alliex.energy.framework.enums.ESystemUser;
import ko.alliex.energy.framework.security.model.LoginInfo;
import ko.alliex.energy.framework.util.Dates;
...
public class AuditInterceptor implements Interceptor {
    ...
    private static final String CREATED_UID_FIELD = "createdUid";
    private static final String CREATED_AT_FIELD = "createdAt";
    private static final String UPDATED_UID_FIELD = "updatedUid";
    ...
    private int getUid(LoginInfo loginInfo) {
        return (loginInfo != null) ? loginInfo.getUserId() : ESystemUser.SYSTEM.code;
    }
}